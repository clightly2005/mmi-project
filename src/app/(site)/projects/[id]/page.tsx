...
export default async function ProjectPage(
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-6">
      <h1 className="text-2xl font-bold hero">
        Project title: <span className="text-sky-600">{project.title}</span>
      </h1>
      <p className="mt-4 text-md hero">
        <span className="font-bold">Project summary:</span> {project.description}
      </p>
      <p className="mt-2 text-md hero">
        <span className="font-bold">Estimated effort:</span> {project.durationWeeks} Weeks
      </p>
